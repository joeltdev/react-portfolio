...
const About = () => {
  return (
    <div className="relative" id="about">
      <div className="py-16 bg-gradient-to-br from-sky-50 via-indigo-50 to-rose-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-base text-gray-700 font-semibold tracking-wide uppercasen ">
              About Me
            </h2>
          ...
          <div className="mt-10">
            <div className="grid grid-cols-1 gap-12 lg:grid-cols-2">
              ...
              <div className="border border-gray-400 rounded-lg md:p-7 py-7  flex flex-col gap-8 items-center shadow-lg shadow-gray-800">
                <h3 className="text-2xl font-normal font-sans text-gray-700">
                  Skills & Expertise
                </h3>
