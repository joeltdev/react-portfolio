...
const About = () => {
  ...
  return (
    <section id="about" className="relative pt-48 md:pt-60 pb-32 px-4 sm:px-6 lg:px-8 bg-gray-50 overflow-hidden scroll-mt-28">
          ...
          <div className="lg:col-span-7">
            ...
            <div className="max-w-2xl">
              ...
              <div className="grid grid-cols-3 gap-4 border-t border-gray-100 pt-8 mt-10">
                ...
                <div className="group/stat bg-white/60 backdrop-blur-sm border border-gray-100/80 rounded-2xl p-4 hover:border-gray-200/85 hover:bg-white hover:shadow-lg hover:shadow-gray-200/30 transition-all duration-300">
                  <span className="text-3xl sm:text-4xl font-black text-gray-950 tracking-tight block group-hover/stat:-translate-y-0.5 transition-transform duration-300">24/7</span>
                  <span className="text-[10px] sm:text-xs text-gray-400 uppercase tracking-widest font-bold mt-1 block">Learning</span>
                </div>
              </div>
            </div>
          </div>
